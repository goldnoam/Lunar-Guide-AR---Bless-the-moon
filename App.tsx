...
const App: React.FC = () => {
  ...
  const [theme, setTheme] = useState<'light' | 'dark'>(() => (localStorage.getItem('lunar-guide-theme') as 'light' | 'dark') || 'light');
